<template>
  <!-- 单个的支付项 -->
  <div
    class="flex-none flex flex-col items-center w-[100px] mt-2 mr-2 py-3 border-[1px] hover:bg-orange-50 hover:border-orange-300 rounded-md relative cursor-pointer xl:w-[125px] xl:py-2"
    :class="[
      select

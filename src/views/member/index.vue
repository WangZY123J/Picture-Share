<template>
  <div
    class="h-[100%] bg-white dark:bg-zinc-800 duration-400 xl:pt-1"
  >
    <div
      class="max-w-screen-lg mx-auto bg-white dark:bg-zinc-900 duration-400 xl:rounded-sm xl:border-zinc-200 xl:dark:border-zinc-600 xl:border-[1px] xl:px-4 xl:shadow-lg"
    >
      <!-- 移动端 navbar 处理 -->
...
const getVipPayListData = async () => {
  const result = await getVipPayList()
  vipPayListData.value = result
